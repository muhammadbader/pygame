...
class Particle:
    ...
    def draw(self, screen):
        ...
        if alpha > 0:
            ...
            pygame.draw.circle(glow_surface, (*self.color, int(alpha // 3)),
...
class TicTacToe:
    ...
    def draw_grid(self):
        ...
        for row in range(GRID_SIZE):
            for col in range(GRID_SIZE):
                ...
                if self.hover_cell == (row, col) and self.board[row][col] == '' and not self.game_over:
                    ...
                    pygame.draw.rect(glow_surface, (*O_COLOR, 30), (0, 0, CELL_SIZE, CELL_SIZE))
        ...
        grid_color_pulsed = tuple(min(255, c + pulse) for c in GRID_COLOR[:3])
        ...
        for i in range(GRID_SIZE + 1):
            ...
            for offset in range(3):
                ...
                pygame.draw.line(glow_surface, (*grid_color_pulsed, alpha),
    ...
    def draw_x(self, x, y, scale=1.0):
        ...
        for glow_level in range(3):
            ...
            offset = int(size + 20)
            pygame.draw.line(glow_surface, (*color, glow_alpha),
    ...
    def draw_winning_line(self):
        ...
        if self.winning_line:
            ...
            for glow in range(4):
                ...
                pygame.draw.line(glow_surface, (*WIN_LINE_COLOR, glow_alpha),
    ...
    def draw_ui(self):
        ...
        glow_title = TITLE_FONT.render(title_text, True, (*TEXT_COLOR, 100))
    ...
    def draw_game_over(self):
        ...
        if self.game_over:
            ...
            # Glow
            for i in range(3):
                glow = WINNER_FONT.render(text, True, (*color, 50 - i * 15))
            ...
            if button_rect.collidepoint(mouse_pos):
                ...
                pygame.draw.rect(glow_surf, (*O_COLOR, 30), (0, 0, 250, 60), border_radius=12)
